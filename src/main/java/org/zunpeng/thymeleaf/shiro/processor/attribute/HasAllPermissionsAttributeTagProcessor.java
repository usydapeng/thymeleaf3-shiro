 ...
 */
public class HasAllPermissionsAttributeTagProcessor extends AbstractAttributeTagProcessor {
	...
	public HasAllPermissionsAttributeTagProcessor(String dialectPrefix) {
		super(
