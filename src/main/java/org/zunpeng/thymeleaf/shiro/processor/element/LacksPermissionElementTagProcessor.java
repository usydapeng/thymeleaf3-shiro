 ...
 */
public class LacksPermissionElementTagProcessor extends AbstractElementTagProcessor {

	private static final String TAG_NAME = "lacksPermission";
	...
	public LacksPermissionElementTagProcessor(final String dialectPrefix) {
		super(
