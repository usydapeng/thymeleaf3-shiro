 ...
 */
public class LacksRoleElementTagProcessor extends AbstractElementTagProcessor {

	private static final String TAG_NAME = "lacksRole";
	...
	public LacksRoleElementTagProcessor(final String dialectPrefix) {
		super(
