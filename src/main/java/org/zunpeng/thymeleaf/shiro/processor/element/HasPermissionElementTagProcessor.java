 ...
 */
public class HasPermissionElementTagProcessor extends AbstractElementTagProcessor {

	private static final String TAG_NAME = "hasPermission";
	...
	public HasPermissionElementTagProcessor(final String dialectPrefix) {
		super(
