 ...
 */
public class HasAnyPermissionsElementTagProcessor extends AbstractElementTagProcessor {

	private static final String TAG_NAME = "hasAnyPermissions";
	...
	public HasAnyPermissionsElementTagProcessor(final String dialectPrefix) {
		super(
