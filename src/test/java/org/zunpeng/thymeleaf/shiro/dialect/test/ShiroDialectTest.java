 ...
 */
package org.zunpeng.thymeleaf.shiro.dialect.test;
...
public class ShiroDialectTest extends AbstractShiroTest {
	...
	private static final String PGKPATH = "org/zunpeng/thymeleaf/shiro/dialect/test";
	...
	public void testPermissions() {
		...
		assertFalse(result.contains("BPERM1"));
		assertFalse(result.contains("BPERM2"));
		assertFalse(result.contains("CPERM1"));
		assertFalse(result.contains("CPERM2"));
		...
		assertTrue(result.contains("BPERM1"));
		assertTrue(result.contains("BPERM2"));
